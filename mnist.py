...
train_dataset = mnist.MNIST(root="./data", train=True, transform=transforms.ToTensor())
validation_dataset = mnist.MNIST(root="./data", train=False, transform=transforms.ToTensor())
...
if __name__ == "__main__":
    ...
    x, y = validation_dataset[random.randint(0, len(validation_dataset))]
    img = transforms.functional.to_pil_image(x.reshape(1, 28, 28)).resize((280, 280))
    img.show()
    with torch.inference_mode():
